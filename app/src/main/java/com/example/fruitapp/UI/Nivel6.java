...
import com.example.fruitapp.UI.MainActivity;
...
public class Nivel6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, R.string.toast_nivel6, Toast.LENGTH_SHORT).show();
    ...
    public  void NumAleatorio (){
        ...
        if ( score <=70){
            ...
            if (numAleatorio_uno >= 0 && numAleatorio_uno <= 3 ){
                resultado = numAleatorio_uno + numAleatorio_dos; // Suma
                iv_signo.setImageResource(R.drawable.adicion);

            } else if (numAleatorio_uno >= 4 && numAleatorio_uno <= 7 ){
                resultado = numAleatorio_uno - numAleatorio_dos; //Resta
                iv_signo.setImageResource(R.drawable.resta);
            } else {
                resultado = numAleatorio_uno * numAleatorio_dos; //Multiplicación
           ...
           //Evita que el resultado sea negativo
            ...
            Toast.makeText(this, R.string.toast_win, Toast.LENGTH_SHORT).show();
